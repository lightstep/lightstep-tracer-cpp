...
class SpanRecord {
 public:
  ...
  static const char* ascii_fingerprint; // = "BF80307314D01C6CDEB6753730BF37BA";
  static const uint8_t binary_fingerprint[16]; // = {0xBF,0x80,0x30,0x73,0x14,0xD0,0x1C,0x6C,0xDE,0xB6,0x75,0x37,0x30,0xBF,0x37,0xBA};
...
class ReportRequest {
 public:
  ...
  static const char* ascii_fingerprint; // = "822AEA65A1F7B99D5E7B5A8B149BF387";
  static const uint8_t binary_fingerprint[16]; // = {0x82,0x2A,0xEA,0x65,0xA1,0xF7,0xB9,0x9D,0x5E,0x7B,0x5A,0x8B,0x14,0x9B,0xF3,0x87};
