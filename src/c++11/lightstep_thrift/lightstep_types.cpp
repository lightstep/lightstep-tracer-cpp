...
void SpanRecord::__set_trace_guid(const std::string& val) {
  this->trace_guid = val;
__isset.trace_guid = true;
}
...
uint32_t SpanRecord::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 11:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->trace_guid);
          this->__isset.trace_guid = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t SpanRecord::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.trace_guid) {
    xfer += oprot->writeFieldBegin("trace_guid", ::apache::thrift::protocol::T_STRING, 11);
    xfer += oprot->writeString(this->trace_guid);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(SpanRecord &a, SpanRecord &b) {
  using ::std::swap;
  swap(a.span_guid, b.span_guid);
  swap(a.trace_guid, b.trace_guid);
  swap(a.runtime_guid, b.runtime_guid);
...
SpanRecord::SpanRecord( SpanRecord&& other51) {
  ...
  trace_guid = std::move(other51.trace_guid);
...
SpanRecord& SpanRecord::operator=(SpanRecord&& other53) {
  ...
  trace_guid = std::move(other53.trace_guid);
...
void SpanRecord::printTo(std::ostream& out) const {
  ...
  out << "SpanRecord(";
  out << "span_guid="; (__isset.span_guid ? (out << to_string(span_guid)) : (out << "<null>"));
  out << ", " << "trace_guid="; (__isset.trace_guid ? (out << to_string(trace_guid)) : (out << "<null>"));
  out << ", " << "runtime_guid="; (__isset.runtime_guid ? (out << to_string(runtime_guid)) : (out << "<null>"));
...
MetricsSample::~MetricsSample() throw() {
}


void MetricsSample::__set_name(const std::string& val) {
  this->name = val;
}

void MetricsSample::__set_int64_value(const int64_t val) {
  this->int64_value = val;
__isset.int64_value = true;
}

void MetricsSample::__set_double_value(const double val) {
  this->double_value = val;
__isset.double_value = true;
}

uint32_t MetricsSample::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->int64_value);
          this->__isset.int64_value = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t MetricsSample::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("MetricsSample");

  xfer += oprot->writeFieldBegin("name", ::apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->name);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.int64_value) {
    xfer += oprot->writeFieldBegin("int64_value", ::apache::thrift::protocol::T_I64, 2);
    xfer += oprot->writeI64(this->int64_value);
    xfer += oprot->writeFieldEnd();
  }
...
void swap(MetricsSample &a, MetricsSample &b) {
  using ::std::swap;
  swap(a.name, b.name);
  swap(a.int64_value, b.int64_value);
  swap(a.double_value, b.double_value);
  swap(a.__isset, b.__isset);
}

MetricsSample::MetricsSample(const MetricsSample& other66) {
  name = other66.name;
  int64_value = other66.int64_value;
  double_value = other66.double_value;
  __isset = other66.__isset;
}
MetricsSample::MetricsSample( MetricsSample&& other67) {
  name = std::move(other67.name);
  int64_value = std::move(other67.int64_value);
  double_value = std::move(other67.double_value);
  __isset = std::move(other67.__isset);
}
MetricsSample& MetricsSample::operator=(const MetricsSample& other68) {
  name = other68.name;
  int64_value = other68.int64_value;
  double_value = other68.double_value;
  __isset = other68.__isset;
  return *this;
}
MetricsSample& MetricsSample::operator=(MetricsSample&& other69) {
  name = std::move(other69.name);
  int64_value = std::move(other69.int64_value);
  double_value = std::move(other69.double_value);
  __isset = std::move(other69.__isset);
  return *this;
}
void MetricsSample::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "MetricsSample(";
  out << "name=" << to_string(name);
  out << ", " << "int64_value="; (__isset.int64_value ? (out << to_string(int64_value)) : (out << "<null>"));
...
void Metrics::__set_counts(const std::vector<MetricsSample> & val) {
  this->counts = val;
__isset.counts = true;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->counts.resize(_size70);
            uint32_t _i74;
            for (_i74 = 0; _i74 < _size70; ++_i74)
            {
              xfer += this->counts[_i74].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.counts = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Metrics::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.counts) {
    xfer += oprot->writeFieldBegin("counts", ::apache::thrift::protocol::T_LIST, 1);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->counts.size()));
      std::vector<MetricsSample> ::const_iterator _iter75;
      for (_iter75 = this->counts.begin(); _iter75 != this->counts.end(); ++_iter75)
      {
...
Metrics::Metrics(const Metrics& other76) {
  counts = other76.counts;
  __isset = other76.__isset;
}
Metrics::Metrics( Metrics&& other77) {
  counts = std::move(other77.counts);
  __isset = std::move(other77.__isset);
}
Metrics& Metrics::operator=(const Metrics& other78) {
  counts = other78.counts;
  __isset = other78.__isset;
  return *this;
}
Metrics& Metrics::operator=(Metrics&& other79) {
  counts = std::move(other79.counts);
...
void Metrics::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "Metrics(";
  out << "counts="; (__isset.counts ? (out << to_string(counts)) : (out << "<null>"));
  out << ")";
}
...
void ReportRequest::__set_internal_logs(const std::vector<LogRecord> & val) {
  this->internal_logs = val;
__isset.internal_logs = true;
}

void ReportRequest::__set_internal_metrics(const Metrics& val) {
  this->internal_metrics = val;
__isset.internal_metrics = true;
}
  ...
  while (true)
  {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->span_records.resize(_size80);
            uint32_t _i84;
            for (_i84 = 0; _i84 < _size80; ++_i84)
            {
              xfer += this->span_records[_i84].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->log_records.resize(_size85);
            uint32_t _i89;
            for (_i89 = 0; _i89 < _size85; ++_i89)
            {
              xfer += this->log_records[_i89].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.log_records = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->counters.resize(_size90);
            uint32_t _i94;
            for (_i94 = 0; _i94 < _size90; ++_i94)
            {
              xfer += this->counters[_i94].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 10:
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            this->internal_logs.clear();
            uint32_t _size95;
            ::apache::thrift::protocol::TType _etype98;
            xfer += iprot->readListBegin(_etype98, _size95);
            this->internal_logs.resize(_size95);
            uint32_t _i99;
            for (_i99 = 0; _i99 < _size95; ++_i99)
            {
              xfer += this->internal_logs[_i99].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.internal_logs = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 11:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          xfer += this->internal_metrics.read(iprot);
          this->__isset.internal_metrics = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t ReportRequest::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.span_records) {
    xfer += oprot->writeFieldBegin("span_records", ::apache::thrift::protocol::T_LIST, 3);
    {
      ...
      std::vector<SpanRecord> ::const_iterator _iter100;
      for (_iter100 = this->span_records.begin(); _iter100 != this->span_records.end(); ++_iter100)
      {
  ...
  if (this->__isset.log_records) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->log_records.size()));
      std::vector<LogRecord> ::const_iterator _iter101;
      for (_iter101 = this->log_records.begin(); _iter101 != this->log_records.end(); ++_iter101)
      {
  ...
  if (this->__isset.counters) {
    xfer += oprot->writeFieldBegin("counters", ::apache::thrift::protocol::T_LIST, 9);
    {
      ...
      std::vector<NamedCounter> ::const_iterator _iter102;
      for (_iter102 = this->counters.begin(); _iter102 != this->counters.end(); ++_iter102)
      {
  ...
  if (this->__isset.internal_logs) {
    xfer += oprot->writeFieldBegin("internal_logs", ::apache::thrift::protocol::T_LIST, 10);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->internal_logs.size()));
      std::vector<LogRecord> ::const_iterator _iter103;
      for (_iter103 = this->internal_logs.begin(); _iter103 != this->internal_logs.end(); ++_iter103)
      {
  ...
  if (this->__isset.internal_metrics) {
    xfer += oprot->writeFieldBegin("internal_metrics", ::apache::thrift::protocol::T_STRUCT, 11);
    xfer += this->internal_metrics.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(ReportRequest &a, ReportRequest &b) {
  ...
  swap(a.internal_logs, b.internal_logs);
  swap(a.internal_metrics, b.internal_metrics);
  swap(a.__isset, b.__isset);
}

ReportRequest::ReportRequest(const ReportRequest& other104) {
  runtime = other104.runtime;
  span_records = other104.span_records;
  log_records = other104.log_records;
  timestamp_offset_micros = other104.timestamp_offset_micros;
  oldest_micros = other104.oldest_micros;
  youngest_micros = other104.youngest_micros;
  counters = other104.counters;
  internal_logs = other104.internal_logs;
  internal_metrics = other104.internal_metrics;
  __isset = other104.__isset;
}
ReportRequest::ReportRequest( ReportRequest&& other105) {
  runtime = std::move(other105.runtime);
  span_records = std::move(other105.span_records);
  log_records = std::move(other105.log_records);
  timestamp_offset_micros = std::move(other105.timestamp_offset_micros);
  oldest_micros = std::move(other105.oldest_micros);
  youngest_micros = std::move(other105.youngest_micros);
  counters = std::move(other105.counters);
  internal_logs = std::move(other105.internal_logs);
  internal_metrics = std::move(other105.internal_metrics);
  __isset = std::move(other105.__isset);
}
ReportRequest& ReportRequest::operator=(const ReportRequest& other106) {
  runtime = other106.runtime;
  span_records = other106.span_records;
  log_records = other106.log_records;
  timestamp_offset_micros = other106.timestamp_offset_micros;
  oldest_micros = other106.oldest_micros;
  youngest_micros = other106.youngest_micros;
  counters = other106.counters;
  internal_logs = other106.internal_logs;
  internal_metrics = other106.internal_metrics;
  __isset = other106.__isset;
  return *this;
}
ReportRequest& ReportRequest::operator=(ReportRequest&& other107) {
  runtime = std::move(other107.runtime);
  span_records = std::move(other107.span_records);
  log_records = std::move(other107.log_records);
  timestamp_offset_micros = std::move(other107.timestamp_offset_micros);
  oldest_micros = std::move(other107.oldest_micros);
  youngest_micros = std::move(other107.youngest_micros);
  counters = std::move(other107.counters);
  internal_logs = std::move(other107.internal_logs);
  internal_metrics = std::move(other107.internal_metrics);
...
void ReportRequest::printTo(std::ostream& out) const {
  ...
  out << ", " << "internal_logs="; (__isset.internal_logs ? (out << to_string(internal_logs)) : (out << "<null>"));
  out << ", " << "internal_metrics="; (__isset.internal_metrics ? (out << to_string(internal_metrics)) : (out << "<null>"));
  out << ")";
}
...
Command::Command(const Command& other108) {
  disable = other108.disable;
  __isset = other108.__isset;
}
Command::Command( Command&& other109) {
  disable = std::move(other109.disable);
  __isset = std::move(other109.__isset);
}
Command& Command::operator=(const Command& other110) {
  disable = other110.disable;
  __isset = other110.__isset;
  return *this;
}
Command& Command::operator=(Command&& other111) {
  disable = std::move(other111.disable);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->commands.resize(_size112);
            uint32_t _i116;
            for (_i116 = 0; _i116 < _size112; ++_i116)
            {
              xfer += this->commands[_i116].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->errors.resize(_size117);
            uint32_t _i121;
            for (_i121 = 0; _i121 < _size117; ++_i121)
            {
              xfer += iprot->readString(this->errors[_i121]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ReportResponse::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.commands) {
    xfer += oprot->writeFieldBegin("commands", ::apache::thrift::protocol::T_LIST, 1);
    {
      ...
      std::vector<Command> ::const_iterator _iter122;
      for (_iter122 = this->commands.begin(); _iter122 != this->commands.end(); ++_iter122)
      {
  ...
  if (this->__isset.errors) {
    xfer += oprot->writeFieldBegin("errors", ::apache::thrift::protocol::T_LIST, 3);
    {
      ...
      for (_iter123 = this->errors.begin(); _iter123 != this->errors.end(); ++_iter123)
      {
...
ReportResponse::ReportResponse(const ReportResponse& other124) {
  commands = other124.commands;
  timing = other124.timing;
  errors = other124.errors;
  __isset = other124.__isset;
}
ReportResponse::ReportResponse( ReportResponse&& other125) {
  commands = std::move(other125.commands);
  timing = std::move(other125.timing);
  errors = std::move(other125.errors);
  __isset = std::move(other125.__isset);
}
ReportResponse& ReportResponse::operator=(const ReportResponse& other126) {
  commands = other126.commands;
  timing = other126.timing;
  errors = other126.errors;
  __isset = other126.__isset;
  return *this;
}
ReportResponse& ReportResponse::operator=(ReportResponse&& other127) {
  commands = std::move(other127.commands);
  timing = std::move(other127.timing);
  errors = std::move(other127.errors);
