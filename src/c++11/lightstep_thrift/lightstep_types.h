...
inline std::ostream& operator<<(std::ostream& out, const MetricsSample& obj)
{
  obj.printTo(out);
  return out;
}
...
class Metrics : public virtual ::apache::thrift::TBase {
 public:
