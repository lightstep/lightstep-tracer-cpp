...
class ReportingService_Report_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "C047D84F5A214B3AC6470C9DBBE0DC29";
  static const uint8_t binary_fingerprint[16]; // = {0xC0,0x47,0xD8,0x4F,0x5A,0x21,0x4B,0x3A,0xC6,0x47,0x0C,0x9D,0xBB,0xE0,0xDC,0x29};
