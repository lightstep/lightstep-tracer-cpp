...
// ReporterIDKey can be used as the key in TracerOptions.tracer_attributes
// to encode the LightStep reporter ID.
extern const char ReporterIDKey[];
...
public:
  ...
  // Tracer attributes.  To define the LightStep Reporter ID manually
  // set ReporterIDKey here.
