...
AresDnsResolver::AresDnsResolver(Logger& logger, EventBase& event_base,
  ...
  options.sock_state_cb = [](void* context, ares_socket_t file_descriptor, int read,
                             int write) noexcept {
...
// OnSocketStateChange
//--------------------------------------------------------------------------------------------------
void AresDnsResolver::OnSocketStateChange(FileDescriptor file_descriptor, int read,
...
// OnEvent
//--------------------------------------------------------------------------------------------------
void AresDnsResolver::OnEvent(FileDescriptor file_descriptor, short what) noexcept try {
