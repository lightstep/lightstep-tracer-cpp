...
// constructor
//------------------------------------------------------------------------------
BipartMemoryOutputStream::BipartMemoryOutputStream(char* data1, size_t size1, char* data2,
                                         size_t size2) noexcept
    : data1_{data1}, size1_{size1}, data2_{data2}, size2_{size2} {}

BipartMemoryInputStream::BipartMemoryInputStream(const char* data1, size_t size1, const char* data2,
                                         size_t size2) noexcept
    : data1_{data1}, size1_{size1}, data2_{data2}, size2_{size2} {}
